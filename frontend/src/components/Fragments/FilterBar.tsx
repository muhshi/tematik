    ...
    <div className="flex min-h-16 flex-col lg:flex-row shrink-0 items-center justify-between gap-4 border-b border-border bg-card px-4 py-4 lg:px-6 lg:py-0">
      ...
      <div className="flex flex-wrap items-center justify-center gap-4 lg:justify-start lg:gap-6">
        ...
        <div className="flex items-center gap-2 max-w-full">
          <span className="text-xs font-semibold text-muted-foreground uppercase tracking-wider shrink-0">Indicator</span>
          <select
            value={selectedIndicatorId}
            onChange={(e) => onIndicatorChange(e.target.value)}
            className="flex h-8 min-w-[220px] max-w-[85vw] md:max-w-[480px] lg:max-w-[600px] items-center justify-between rounded-md border border-input bg-card px-3 py-1 text-sm font-medium shadow-xs ring-offset-background placeholder:text-muted-foreground focus:outline-none focus:ring-1 focus:ring-ring truncate cursor-pointer"
          >
        ...
        <div className="flex items-center gap-2">
          ...
          <select 
            ...
            className="flex h-8 items-center justify-between rounded-md border border-input bg-card px-3 py-1 text-sm font-medium shadow-xs ring-offset-background placeholder:text-muted-foreground focus:outline-none focus:ring-1 focus:ring-ring disabled:cursor-not-allowed disabled:opacity-50 cursor-pointer"
          >
            {yearsLoading ? (
